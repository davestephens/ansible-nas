...
You can also set a traditional mount point if you wish with the `mountpoint` property.
...
> Snapshots do not replace the need for backups. Nothing replaces the need for backups
> except more backups.
